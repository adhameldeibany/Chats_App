    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          chat_message_templete(
              'assets/images/img2.jpg', 'Ahmed', 'How are you ?', '12:36 AM', size),
          chat_message_templete(
              'assets/images/img1.jpg', 'Mahmoud', 'Where are you ?', '2:40 PM', size),
          chat_message_templete(
      ...
      floatingActionButton: InkWell(
        child: FloatingActionButton(
          ...
          child: InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => Camera(title: '',)));
              },
        ...
        child: ListView(
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              ...
              accountName: Text('Adham Eldeibany',
                style: TextStyle(fontSize: 16),
              ),
              accountEmail: Text('adhameldeibany1@gmail.com',
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => AboutPrivacy()));
              },
            ),
          ],
        ),
